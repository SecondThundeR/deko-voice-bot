...
process.env.OPERATIONS_TOKEN = "test-operations-token-123";
process.env.OPERATIONS_URL = "http://localhost:3003";
...
const baseConfig = {
    ...
    operationsToken: "test-operations-token-123",
    operationsUrl: "http://localhost:3003",
};
        ...
        assert.throws(
            () =>
                createConfigFromEnvironment({
                    ...
                    OPERATIONS_TOKEN: "test-operations-token-123",
                    OPERATIONS_URL: "http://localhost:3003",
                }),
            (error: unknown) => {
