...
import { startSubmissionCleanup } from "./bot/features/submission-moderation.ts";
...
async function startPolling(config: PollingConfig) {
    ...
    await configureWebAppMenu(bot, config);
...
async function configureWebAppMenu(
...
try {
    ...
    lifecycle.onShutdown(startSubmissionCleanup());
