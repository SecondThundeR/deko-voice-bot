...
import { databaseTrafficGatekeep } from "#root/backup/restore-coordinator.js";
...
import { conversationStorage, sessionStorage } from "./session/state.ts";
...
export function createBot(
    ...
    protectedBot.filter(isAdmin).use(voicesMenu);
