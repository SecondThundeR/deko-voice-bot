...
Для хранения пользовательских и conversation-сессий требуется Redis. Укажите URL подключения в `REDIS_URL`; в Railway его можно взять из переменных добавленного Redis-сервиса. Сессии хранятся 24 часа с момента последнего изменения.
