...
stats =
    ...
    { $mostUsedVoices }
    .cacheQuote = <blockquote>Статистика использует кеширование для оптимизации вызовов к БД. Данные инвалидируются по истечении 30 минут после последнего запроса</blockquote>
...
optin =
    ...
    .error = Ваших данных нет в статистике, но вы и не удалялись из нее. Попробуйте использовать бота, чтобы добавить свои данные в статистику
...
invalidate =
    ...
    .disabled = Кеширование было отключено
